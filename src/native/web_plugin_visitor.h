...
#ifndef CEF_TESTS_CEFCLIENT_WEB_PLUGIN_INFO_VISITOR_H_
#define CEF_TESTS_CEFCLIENT_WEB_PLUGIN_INFO_VISITOR_H_
#pragma once
...
#endif  // CEF_TESTS_CEFCLIENT_WEB_PLUGIN_INFO_VISITOR_H_
