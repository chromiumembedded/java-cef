...
#ifndef CEF_TESTS_CEFCLIENT_BROWSER_PROCESS_HANDLER_H_
#define CEF_TESTS_CEFCLIENT_BROWSER_PROCESS_HANDLER_H_
#pragma once
...
#endif  // CEF_TESTS_CEFCLIENT_BROWSER_PROCESS_HANDLER_H_
